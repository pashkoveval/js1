...
btns.forEach(element => clickHandler(element))
...
function showCategory(category) {
    ...
    if (category == 'tv') {
        let product = products.tv;
        console.log(product);
        getProductMarkup(product)
    } else if (category == 'phones') {
        let product = products.phones;
        console.log(product);
        getProductMarkup(product)
    } else if (category == 'tablets') {
        let product = products.tablets;
        console.log(product);
        getProductMarkup(product)
    }
}
...
function getProductMarkup(product) {
    ...
    product.forEach(el => rendereng(el))

}

function rendereng(product) {
    productsHTML.insertAdjacentHTML('afterbegin', `
        <div class = "product">
